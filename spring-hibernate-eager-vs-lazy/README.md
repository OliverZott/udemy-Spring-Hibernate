...
1. **Lazy** Loading vs **Eager** Loading   
    ...
    - Session has to be **open** to retrieve lazy-loading data  
    - 2 common options of Retrieving:  
        - `session.get()` and `getter`
        - `session.query()` HQL
    - Hibernate behaviour [(Link Q&A)](https://www.udemy.com/course/spring-hibernate-tutorial/learn/lecture/8058122#questions/12898922)
    - 
